...
\frame{
 ...
 \begin{itemize}
  ...
  \item Heuristi\v cka karakteristika se algoritama se o\v citovala u rezultatima, te je stoga potrebno daljnje istra\v zivanje kako bi se pokazalo koji je od predstavljenih algoritama zapravo 'najbolji'.
  \item Velika vremenska \v slozenost se vidi u rezultatima svih algoritama, pogotovo na ispitivanju jako slo\v zenih funkcija.
