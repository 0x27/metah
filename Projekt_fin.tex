...
\frame{
  ...
  \begin{itemize}
   \item $f(x_i)=\sum_{i=1}^{3}x_i^2, x_i \in [-5.12,5.12], i =1,2,3$
  \end{itemize}
  slika
}
...
\frame{
  ...
  \begin{itemize}
   \item $f(x_i)=\sum_{i=1}^{5}\lfloor x_i\rfloor, x_i \in [-5.12,5.12], i =1,2,3,4,5$
  \end{itemize}
  slika
}
...
\frame{
  ...
  \begin{itemize}
   \item $f(x,y)=0.5+\frac{sin^2(\sqrt{x^2 + y^2})-0.5}{[1+0.001 \cdot (x^2 + y^2)]^2}, (x,y)\in [-100,100]^2$
  \end{itemize}
  slika
}
...
\frame{
  ...
  \begin{itemize}
   \item $f(x_1 \cdots x_{30}) = -20 exp(-0.2 \sqrt{\frac{1}{30} \sum_{i=1}^{30} x_i^2}) - exp(\frac{1}{30} \sum_{i=1}^{30} cos(2\pi x_i)) + 20 + e, x_i\in [-30, 30], i=1,2,...,30$
  \end{itemize}
  slika
}
...
\frame{
  ...
  \begin{tabular}{c|c|c|c|c}
   ...
   \multirow{4}{*}{ABC} & 38.03 & 475.53 & 2 & N/A\\  
   	& 224.60 & 355.93 & 1.93 & N/A\\
   	& 447.23 & 273.33 & 2.70 & N/A\\
   	& 630 & 323.20 & 2.57 & N/A\\ \hline
   \multirow{4}{*}{PSO} & 50.73 & 350.33 & 234.30 & 10 000 \\ 
    & 51.67 & 15.80 & 130.03 & 10 000 \\
    & 52 & 16.63 & 135.07 & 10 000 \\
    & 53.5 & 14.10 & 118.30 & 10 000 \\\hline
  \multirow{4}{*}{OPSO} & 28.63 & 6.27 & 76.83 & 8678.27\\
    & 25.73 & 4.83 & 51.97 & 4378.37\\
    & 23.67 & 4.87 & 36.13 & 2714.97\\
    & 25.73 & 4.87 & 38.4 & 1393.00 \\
  \end{tabular}
  \end{center}
}
...
\frame{
  \frametitle{Grafi\v cki prikaz prikaz - 3}
  
}

\frame{
  \frametitle{Grafi\v cki prikaz prikaz - 4}
