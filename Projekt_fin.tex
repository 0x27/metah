...
\frame{
 ...
 \begin{itemize}
  ...
  \item OPSO je uz pomo\' c svoje lokalne pretrage pokazao da je superjorniji od standarnih ABC i PSO po broju potrebnih iteracija za pronalazak optimalnog rje\v senja.
  \item Stohasti\v cka karakteristika se algoritama se o\v citovala u rezultatima, te je stoga potrebno daljnje istra\v zivanje kako bi se pokazalo koji je od predstavljenih algoritama zapravo 'najbolji'.
  \item Velika vremenska \v slozenost se vidi u rezultatima svih algoritama, pogotovo na ispitivanju jako slo\v zenih funkcija (npr. Ackley).
